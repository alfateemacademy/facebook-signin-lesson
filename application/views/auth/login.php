  ...
  <div class="row login-container column-seperation">  
        <div class="col-md-5 col-md-offset-1">
          ...
          <br>
		   ...
		   <a class="btn btn-block btn-info col-md-8" href="<?php echo $loginUrl; ?>">
...
<script src="<?php echo site_url('assets/plugins/jquery-validation/js/jquery.validate.min.js'); ?>" type="text/javascript"></script>
<script src="<?php echo site_url('assets/js/login.js'); ?>" type="text/javascript"></script>
